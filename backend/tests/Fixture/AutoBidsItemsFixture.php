...
/**
 * AutoBidsItemsFixture
 */
class AutoBidsItemsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'auto_bids_items_ibfk_1' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'auto_bids_items_ibfk_2' => ['type' => 'foreign', 'columns' => ['item_id'], 'references' => ['auction_items', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
